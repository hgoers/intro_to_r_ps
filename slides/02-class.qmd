...
::: aside
We will go over this in much more detail tomorrow. 
:::

## EXERCISE {background-color="#B56576"}

5.  Add a useful message in the message area. 

6.  Hit the commit button. 

7.  Push your work to Github. 

8.  Head over to your class repository on Github. You should see your file. 
