...
We need to install Git. Follow these instructions: [https://happygitwithr.com/install-git](https://happygitwithr.com/install-git).
...
::: {.aside}
Your username does not need to be your Github username. You can provide your actual first and last name, if you would like. Your user email MUST be the same email as the one you used to register your Github account. 
:::
