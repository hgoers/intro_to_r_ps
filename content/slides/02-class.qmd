...
ggplot(data = mpg, mapping = aes(x = displ, y = hwy)) + 
  geom_point(mapping = aes(colour = class, shape = class)) + 
...
## Make your visualizations more accessible

```{r}
#| code-line-numbers: "1,3"

ggplot(data = mpg, mapping = aes(x = displ, y = hwy, colour = class, shape = class)) + 
  geom_point() + 
  scale_color_colorblind()
```
